"""FastAPI router for the spotify_dl service."""
...
from spotify_dl.job_runner import (
    build_zip,
    create_job,
...
async def form(request: Request):
    ...
    return _templates(request).TemplateResponse(request, "spotify_dl/form.html")
...
async def job_page(request: Request, job_id: str):
    ...
    return _templates(request).TemplateResponse(
        request, "spotify_dl/job_status.html",
        {
            "job": job,
...
async def job_fragment(request: Request, job_id: str):
    ...
    return _templates(request).TemplateResponse(
        request, "spotify_dl/_status_fragment.html",
        {
            "job": job,
            "fragment_url": fragment_url,
            "download_url": download_url,
