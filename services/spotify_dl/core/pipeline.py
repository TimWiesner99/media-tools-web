"""
spotify_dl pipeline — web-adapted version of spotify_dl.py.
...
from spotify_dl.core.youtube_search import get_youtube_link
from spotify_dl.core.downloader import download_youtube_content
...
MUSICBRAINZ_USERAGENT = (
    "spotify-dl-music",
    "1.0",
    "spotify-dl-music@users.noreply.github.com",
)
...
def run_pipeline(
    ...
    """
    Run the full spotify_dl pipeline.
    ...
    video_ids: list[str | None] = [None] * len(tracks)
