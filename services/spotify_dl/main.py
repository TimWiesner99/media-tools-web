"""FastAPI sub-application for the spotify_dl (Spotify → MP3) service."""
...
from spotify_dl.job_runner import cleanup_old_jobs
from spotify_dl.router import router
...
app.state.templates = create_templates(BASE_DIR / "templates")
